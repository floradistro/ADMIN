...
export function AuditDropdown({ isOpen, onClose }: AuditDropdownProps) {
  ...
  return (
    <div 
      ref={dropdownRef}
      className="absolute right-0 top-full mt-1 w-[480px] max-h-[70vh] bg-neutral-900/95 border border-white/[0.08] rounded-lg shadow-2xl backdrop-blur-sm z-50 overflow-hidden"
    >
