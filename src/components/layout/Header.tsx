        ...
        <div className="relative flex items-center h-full px-1.5">
          ...
          <div className="md:hidden flex items-center w-full gap-1">
            ...
            <div className="relative flex-shrink-0" ref={mobileMenuRef}>
              ...
              {isMobileMenuOpen && (
                <div className="absolute top-full left-0 mt-1 bg-neutral-800 border border-white/[0.08] rounded-lg shadow-2xl z-50 w-64 max-h-[80vh] overflow-y-auto">
                  <div className="p-2 space-y-1">
                    {/* Views Section */}
                    <div className="px-2 py-1 text-[9px] text-neutral-500 uppercase font-bold">Views</div>
                    <button
                      onClick={() => { onProductsToggle?.(); setIsMobileMenuOpen(false); }}
                      className="w-full text-left px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition flex items-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                      Products
                    </button>
                    <button
                      onClick={() => { onCustomersToggle?.(); setIsMobileMenuOpen(false); }}
                      className="w-full text-left px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition flex items-center gap-2"
                    >
                    ...
                    <button
                      onClick={() => { onViewChange({ isOrdersViewOpen: !viewState.isOrdersViewOpen }); setIsMobileMenuOpen(false); }}
                      className="w-full text-left px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition flex items-center gap-2"
                    >
                    ...
                    <button
                      onClick={() => { onReportsToggle?.(); setIsMobileMenuOpen(false); }}
                      className="w-full text-left px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition flex items-center gap-2"
                    >
                    ...
                    {/* Files Section */}
                    <div className="px-2 py-1 text-[9px] text-neutral-500 uppercase font-bold">Files</div>
                    <button
                      onClick={() => { onMediaToggle?.(); setIsMobileMenuOpen(false); }}
                      className="w-full text-left px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition flex items-center gap-2"
                    >
                    ...
                    <button
                      onClick={() => { onCoaToggle?.(); setIsMobileMenuOpen(false); }}
                      className="w-full text-left px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition flex items-center gap-2"
                    >
                    ...
                    {/* Filters Section (Products only) */}
                    {isProductsTab && (
                      <>
                        <div className="px-2 py-1 text-[9px] text-neutral-500 uppercase font-bold">Filters</div>
                        <label className="flex items-center justify-between px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition cursor-pointer">
                          <span>Hide Zero Stock</span>
                          <input
                            type="checkbox"
                            checked={filterState.hideZeroQuantity || false}
                            onChange={() => onHideZeroQuantityChange?.(!filterState.hideZeroQuantity)}
                        ...
                        <label className="flex items-center justify-between px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition cursor-pointer">
                          ...
                          <input
                            type="checkbox"
                            checked={filterState.showSelectedOnly || false}
                            onChange={() => onShowSelectedOnlyChange?.(!filterState.showSelectedOnly)}
                            className="rounded border-neutral-600 bg-neutral-700 text-green-500"
                          />
                        </label>
                        <div className="my-2 border-t border-white/[0.08]"></div>
                      </>
                    ...
                    {/* Settings */}
                    <button
                      onClick={() => { onSettingsToggle?.(); setIsMobileMenuOpen(false); }}
                      className="w-full text-left px-3 py-2 text-sm text-neutral-300 hover:bg-white/[0.05] rounded transition flex items-center gap-2"
                    >
