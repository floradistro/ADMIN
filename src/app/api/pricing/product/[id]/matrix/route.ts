...
// GET /api/pricing/product/[id]/matrix - Get price matrix for product
export async function GET(
  ...
  try {
    ...
    const url = buildUrl(`/price/product/${id}/matrix`, apiParams);
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: 'Failed to get price matrix', details: errorText },
